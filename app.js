            ...
            ">
                ...
                <div style="padding:20px;">
                    ...
                    <div style="margin-bottom:20px;">
                        ...
                        <input type="text" id="cheese-guest-name" placeholder="z.B. Familie Müller" style="
                            width:100%;
                            padding:14px;
                    ...
                    ">
                        <div style="display:flex;justify-content:space-between;margin-bottom:8px;">
                            <span>Käse (<span id="cheese-price-grams">100</span>g × 2,50 €/100g)</span>
