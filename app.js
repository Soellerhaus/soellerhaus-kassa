...
(async function initApp() {
    ...
    try {
        ...
        setTimeout(() => {
            ...
            // WhatsApp Support-Button hinzufügen
            addWhatsAppSupportButton();
        }, 1500);
        ...
        // WhatsApp Button auch bei Fehler
        addWhatsAppSupportButton();
    }
})();
...
// ===========================================
function addWhatsAppSupportButton() {
    ...
    // Button HTML
    const buttonHtml = `
    <div id="whatsapp-support-btn" style="
        position: fixed;
        bottom: 20px;
        right: 20px;
        z-index: 9998;
    ...
    ">
        <div id="whatsapp-tooltip" style="
            ...
            text-align: center;
        ">
            Problem? Screenshot per WhatsApp senden!
        </div>
        <button onclick="openWhatsAppSupport()" style="
            ...
            justify-content: center;
            transition: transform 0.2s, box-shadow 0.2s;
        " onmouseover="this.style.transform='scale(1.1)';this.style.boxShadow='0 6px 25px rgba(37, 211, 102, 0.5)';document.getElementById('whatsapp-tooltip').style.display='block'" 
           onmouseout="this.style.transform='';this.style.boxShadow='0 4px 15px rgba(37, 211, 102, 0.4)';document.getElementById('whatsapp-tooltip').style.display='none'"
           ontouchstart="document.getElementById('whatsapp-tooltip').style.display='block'"
        >
...
// WhatsApp öffnen mit vorausgefüllter Nachricht
window.openWhatsAppSupport = () => {
    const whatsappNummer = '436701818001';
    
    // Gerätedaten sammeln
    const geraeteId = localStorage.getItem('device_id') || 'unbekannt';
    const userName = State.currentUser?.firstName || State.currentUser?.vorname || 'Nicht angemeldet';
    const currentPage = window.location.hash || '#login';
    const timestamp = new Date().toLocaleString('de-AT');
    
    // Nachricht zusammenbauen
    const nachricht = `🆘 *Support-Anfrage Söllerhaus Kassa*

👤 Benutzer: ${userName}
📱 Geräte-ID: ${geraeteId.substring(0, 8)}
📍 Seite: ${currentPage}
🕐 Zeit: ${timestamp}

📸 *Bitte Screenshot anhängen!*
