...
<head>
    ...
    <meta name="description" content="Söllerhaus Self-Service Buchungssystem">
    
    <title>Söllerhaus Kassa</title>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Archivo:wght@300;400;500;700&family=Crimson+Pro:wght@400;600;700&display=swap" rel="stylesheet">
    
    <!-- Styles -->
    <link rel="stylesheet" href="styles.css">
    
    <!-- Dexie.js for IndexedDB (lokaler Cache) -->
    <script src="https://unpkg.com/dexie@3.2.4/dist/dexie.min.js"></script>
    
    <!-- SheetJS fÃƒÆ’Ã‚Â¼r Excel Export -->
    <script src="https://cdn.sheetjs.com/xlsx-0.20.0/package/dist/xlsx.full.min.js"></script>
    
    <!-- Supabase Client fÃƒÆ’Ã‚Â¼r Multi-Device Sync -->
...
<body>
    ...
    <!-- Fallback: Falls App nicht lädt, Loading Screen nach 10 Sek verstecken -->
    <script>
        setTimeout(function() {
            var loadingScreen = document.getElementById('loading-screen');
            var appContainer = document.getElementById('app');
            if (loadingScreen && loadingScreen.style.display !== 'none') {
                console.warn('Ã¢Å¡Â Ã¯Â¸Â App-Start dauert zu lange - Loading Screen wird ausgeblendet');
                loadingScreen.style.display = 'none';
                if (appContainer) {
                    appContainer.style.display = 'block';
                    appContainer.innerHTML = '<div style="padding:40px;text-align:center;"><h2 style="color:#c0392b;">Ã¢Å¡Â Ã¯Â¸Â Ladefehler</h2><p style="margin:20px 0;">Die App konnte nicht vollständig geladen werden.</p><button onclick="location.reload(true)" style="padding:15px 30px;font-size:16px;background:#2C5F7C;color:white;border:none;border-radius:8px;cursor:pointer;">Ã°Å¸â€â€ž Neu laden</button><p style="margin-top:20px;font-size:12px;color:#888;">Tipp: Cache leeren (Strg+Shift+R) oder Browser-Daten löschen</p></div>';
                }
            }
        }, 10000);
    </script>
