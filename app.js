        ...
        <div class="card">
            ...
            <div class="form-group">
                ...
                <div class="pin-buttons">
                    ...
                    <button type="button" class="pin-btn pin-btn-delete" onclick="handleRegisterPinDelete()">âŒÂ«</button>
                </div>
            </div>
    ...
    UI.render(`${langBtn}<div class="main-content"><div style="max-width:500px;margin:60px auto;">
        <div class="card">
            ...
            <div class="pin-buttons">
                ...
                <button type="button" class="pin-btn pin-btn-delete" onclick="handleLoginPinDelete()">âŒÂ«</button>
            </div>
