...
// ===============================================
// KORRIGIERTE STORNO-FUNKTION
// ===============================================
// Diese Funktion ersetzt die alte storno() Funktion in app.js
// Sie erstellt automatisch eine Gegenbuchung in Supabase,
// die IDEAS automatisch abholt und importiert.
// ===============================================
...
async storno(buchung_id) {
    ...
    if (b.exportiert === true) {
        ...
        const gegenbuchung = {
            ...
            ist_storno: true                  // Kennzeichnung als Storno
        };
...
// INSTALLATION
// ===============================================
// 1. Öffne app.js in deinem Editor
// 2. Suche nach: "async storno(buchung_id) {"
// 3. Ersetze die komplette Funktion (bis zur schließenden Klammer)
//    mit dem Code oben
// 4. Speichern & zu GitHub committen
// 5. Cache leeren (Strg+Shift+R)
// 6. Testen!
// ===============================================
...
// ===============================================
// 
// VORHER (alte Lösung - funktionierte NICHT):
// 1. Buchung stornieren → storniert: true
// 2. Beim Export → Negativ-Buchung in Excel
// 3. Excel manuell importieren → ❌ IDEAS ignoriert stornierte Buchungen!
//
// NACHHER (neue Lösung - funktioniert!):
// 1. Buchung stornieren → storniert: true
// 2. Automatisch Gegenbuchung erstellen in Supabase:
//    - storniert: false ✅ (IDEAS sieht sie!)
//    - exportiert: false ✅ (IDEAS holt sie!)
//    - menge: -1, preis: -2,50 (negativ!)
// 3. IDEAS Auto-Sync (alle 30 Sek) → holt Gegenbuchung automatisch
// 4. Artikel verschwindet von Registrierkasse! ✅
//
// ===============================================
