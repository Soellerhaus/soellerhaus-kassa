        ...
        <div class="card">
            ...
            <div class="form-group">
                ...
                <div class="pin-buttons">
                    ...
                    <button type="button" class="pin-btn pin-btn-delete" onclick="handleRegisterPinDelete()">❌Â«</button>
                </div>
            </div>
    ...
    UI.render(`${langBtn}<div class="main-content"><div style="max-width:500px;margin:60px auto;">
        <div class="card">
            ...
            <div class="pin-buttons">
                ...
                <button type="button" class="pin-btn pin-btn-delete" onclick="handleLoginPinDelete()">❌Â«</button>
            </div>
            ...
            <div class="card-body">
                <div style="background:var(--color-stone-light);padding:16px;border-radius:8px;margin-bottom:16px;">
                    <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px;">
                        <span style="font-size:1.5rem;">${aktiveNachricht.typ === 'dringend' ? '🚨' : aktiveNachricht.typ === 'warnung' ? '⚠ï¸' : 'ℹ️'}</span>
